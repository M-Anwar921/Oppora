      ...
      <div className="space-y-4 max-w-xl">
        <div className="p-5 rounded-2xl bg-base-card ring-1 ring-base-border">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-8 h-8 rounded-lg bg-accent-blue/12 flex items-center justify-center">
              <Server size={17} className="text-accent-blue" />
            </div>
            <p className="text-[16.1px] font-semibold text-ink-primary">Backend connection</p>
          </div>
          <p className="text-[14.9px] text-ink-secondary mb-3">
          ...
          <div className="px-3.5 py-2.5 rounded-lg bg-base-surface ring-1 ring-base-border text-[14.9px] font-mono text-ink-secondary">
            {API_BASE_URL}
          </div>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-base-card ring-1 ring-base-border">
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-[16.1px] font-semibold text-ink-primary">Data mode</p>
          </div>
        ...
        <div className="p-5 rounded-2xl bg-base-card ring-1 ring-base-border">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-8 h-8 rounded-lg bg-state-danger/12 flex items-center justify-center">
              <RotateCcw size={17} className="text-state-danger" />
            </div>
            <p className="text-[16.1px] font-semibold text-ink-primary">Reset local data</p>
          </div>
          <p className="text-[14.9px] text-ink-secondary mb-4">
            Clears your saved profile and analysis results stored in this browser.
          </p>
          <button
            onClick={handleReset}
            className="px-4 py-2.5 rounded-lg bg-state-danger/12 ring-1 ring-state-danger/30 text-state-danger text-[14.9px] font-medium hover:bg-state-danger/18 transition-colors"
          >
